%-------------------------
% Resume
% Author : Fayaz Hussain Sahito
% Based off of: https://github.com/engrfayyazhussainsahito/cv-master-fayyaz
% License : MIT
%------------------------
...
\section{Professional Certifications}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Microsoft Certified: Azure Fundamentals (AZ-900)} $|$ \emph{Microsoft}}{2024}
          \vspace{-13pt}
      ...
      \resumeProjectHeading
          ...
          \vspace{-13pt}
      \resumeProjectHeading
          {\textbf{Mastery in Penetration Testing} $|$ \emph{PENTESTER ACADEMY}}{2021}
          \vspace{-13pt}
      \resumeProjectHeading
          {\textbf{Introduction to IoT} $|$ \emph{CISCO}}{2020}
          \vspace{-13pt}
    \resumeSubHeadingListEnd
\vspace{-5pt}
